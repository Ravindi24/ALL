...
def preprocess_inputs(gen, age, diagnosis, risk, initial_wbc):
    try:
        ...
        return [[gen, age, diagnosis, risk, initial_wbc]]
    except ValueError:
...
def run():
    ...
    if st.button("Submit"):
        ...
        features = preprocess_inputs(gen, age, diagnosis, risk, initial_wbc)
        if features is None:
            return
